...
import { bolehAkses, konfirmasiPassword, sesi } from "./auth.js?v=3.11.2";
import { simpanPelangganOtomatis } from "./pelanggan.js?v=3.11.2";
import { terapkanPerubahanUnit } from "./stok.js?v=3.11.2";
import { hitungTotalDibayar } from "./cetak.js?v=3.11.2";
import { buatNotifikasi } from "./notifikasi.js?v=3.11.2";
import { tanya, konfirmasi } from "./dialog.js?v=3.11.2";
import { aman, kabar, tanggalJam, namaTampilan } from "./ui.js?v=3.11.2";
