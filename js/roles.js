...
import { labelItem, labelGrup } from "./label.js?v=3.13.0";
import { daftarKodeUntuk } from "./akses.js?v=3.13.0";
import { dbase, doc, getDoc } from "./db.js?v=3.13.0";
...
const SISTEM_LENGKAP = { grup: "Sistem", butir: [
  ...
  { label: "Tentang Aplikasi", rute: "#/tentang", kode: "SYS-13" },
]};
