...
import { dbase, collection, getDocs, query, where, orderBy, limit }
  from "./db.js?v=3.16.0";
import { bolehAkses } from "./auth.js?v=3.16.0";
import { aman, tanggalJam } from "./ui.js?v=3.16.0";
...
export const LABEL_AKSI = {
  ...
  akun_biro_jasa_dibuat: "Membuat akses login Biro Jasa",
  akun_biro_jasa_status_diubah: "Mengubah status akses login Biro Jasa",
  berkas_diserahkan_biro: "Menyerahkan berkas ke Biro Jasa",
  berkas_batal_serah: "Membatalkan serah berkas (sebelum dikonfirmasi)",
  berkas_dikonfirmasi_biro: "Mengonfirmasi terima berkas",
  berkas_ditarik_kembali: "Menarik kembali berkas (sesudah dikonfirmasi)",
  dokumen_mulai_diproses: "Mulai memproses dokumen (STNK/BPKB/Plat)",
  ...
  channel_ditambah: "Menambah channel",
  channel_diubah: "Mengubah channel",
  channel_status_diubah: "Mengubah status channel",
  transfer_unit_dibuat: "Mentransfer unit ke channel",
  transfer_unit_dikembalikan: "Mengembalikan unit dari channel",
  tarik_unit_dibuat: "Menarik unit dari channel",
  faktur_diajukan: "Mencetak pengajuan faktur",
  transfer_unit_migrasi: "Memulihkan status unit di channel (perbaikan stok)",
};
