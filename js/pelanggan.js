...
import { aman, kabar, tanggal, rupiah, pasangHurufBesar, namaTampilan } from "./ui.js?v=3.13.1";
import { konfirmasi } from "./dialog.js?v=3.13.1";
import { cetakSpk, mintaCetakKuitansi, labelTombolKuitansi, sudahLunas,
  cetakUlangKuitansiTerakhir } from "./cetak.js?v=3.13.1";
