...
import { PERAN } from "./roles.js?v=3.2.5";
import { muatTipe, tipeDari, sinkronKatalog } from "./tipe.js?v=3.2.5";
import { pecahHarga } from "./config.js?v=3.2.5";
import { beritahu } from "./dialog.js?v=3.2.5";
import { muatSupplier, supplierAktif } from "./supplier.js?v=3.2.5";
import { beriTahuSemuaOwner } from "./notifikasi.js?v=3.2.5";
