...
import { dbase, collection, getDocs, query, where, orderBy } from "./db.js?v=3.9.2";
import { sesi } from "./auth.js?v=3.9.2";
import { muatTipe } from "./tipe.js?v=3.9.2";
import { rupiah, aman, namaTampilan } from "./ui.js?v=3.9.2";
import { resolveNamaSales, hargaEfektif } from "./cetak.js?v=3.9.2";
