...
import { dbase, collection, getDocs, query, where, orderBy } from "./db.js?v=3.10.3";
import { sesi } from "./auth.js?v=3.10.3";
import { muatTipe } from "./tipe.js?v=3.10.3";
import { rupiah, aman, namaTampilan } from "./ui.js?v=3.10.3";
import { resolveNamaSales, hargaEfektif } from "./cetak.js?v=3.10.3";
