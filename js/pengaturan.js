...
import { sesi, bolehAkses } from "./auth.js?v=3.7.3";
import { PERAN, batasDiskon } from "./roles.js?v=3.7.3";
import { FIREBASE } from "./config.js?v=3.7.3";
import { konfirmasi, tanya, beritahu } from "./dialog.js?v=3.7.3";
import { rupiah, aman, kabar, tanggal, keTanggal } from "./ui.js?v=3.7.3";
